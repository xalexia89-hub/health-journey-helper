...
// Demo members data — 50 members for pilot
const demoMembers = [
  ...
  { id: '13', member_code: 'MBR-013', full_name: 'Χριστίνα Παππά', gender: 'F', date_of_birth: '1992-02-14', policy_type: 'Basic', risk_category: 'low', risk_score: 10, stability_score: 95, compliance_score: 91, chronic_conditions: [], er_visits_ytd: 0, total_claims_amount: 220, is_active: true, last_claim_date: '2025-10-05' },
  { id: '14', member_code: 'MBR-014', full_name: 'Στέφανος Καραγιάννης', gender: 'M', date_of_birth: '1970-06-30', policy_type: 'Premium', risk_category: 'medium', risk_score: 48, stability_score: 65, compliance_score: 70, chronic_conditions: ['Υπέρταση', 'Δυσλιπιδαιμία'], er_visits_ytd: 1, total_claims_amount: 6700, is_active: true, last_claim_date: '2026-01-20' },
  { id: '15', member_code: 'MBR-015', full_name: 'Θεοδώρα Μακρή', gender: 'F', date_of_birth: '1985-09-12', policy_type: 'Standard', risk_category: 'low', risk_score: 14, stability_score: 91, compliance_score: 89, chronic_conditions: ['Αλλεργικό άσθμα'], er_visits_ytd: 0, total_claims_amount: 1800, is_active: true, last_claim_date: '2025-12-10' },
  { id: '16', member_code: 'MBR-016', full_name: 'Αθανάσιος Κόκκινος', gender: 'M', date_of_birth: '1958-04-08', policy_type: 'Premium', risk_category: 'high', risk_score: 74, stability_score: 42, compliance_score: 50, chronic_conditions: ['Διαβήτης Τ2', 'CHF'], er_visits_ytd: 4, total_claims_amount: 28900, is_active: true, last_claim_date: '2026-02-10' },
  { id: '17', member_code: 'MBR-017', full_name: 'Ευαγγελία Τσούκα', gender: 'F', date_of_birth: '1980-01-25', policy_type: 'Standard', risk_category: 'low', risk_score: 16, stability_score: 88, compliance_score: 85, chronic_conditions: [], er_visits_ytd: 0, total_claims_amount: 900, is_active: true, last_claim_date: '2025-11-30' },
  { id: '18', member_code: 'MBR-018', full_name: 'Λεωνίδας Σταματόπουλος', gender: 'M', date_of_birth: '1974-11-17', policy_type: 'Basic', risk_category: 'medium', risk_score: 42, stability_score: 70, compliance_score: 74, chronic_conditions: ['Γαστροοισοφαγική παλινδρόμηση'], er_visits_ytd: 1, total_claims_amount: 3800, is_active: true, last_claim_date: '2026-01-05' },
  { id: '19', member_code: 'MBR-019', full_name: 'Δέσποινα Χατζή', gender: 'F', date_of_birth: '1993-07-02', policy_type: 'Basic', risk_category: 'low', risk_score: 7, stability_score: 97, compliance_score: 94, chronic_conditions: [], er_visits_ytd: 0, total_claims_amount: 150, is_active: true, last_claim_date: '2025-08-22' },
  { id: '20', member_code: 'MBR-020', full_name: 'Χρήστος Οικονόμου', gender: 'M', date_of_birth: '1962-03-28', policy_type: 'Premium', risk_category: 'high', risk_score: 70, stability_score: 47, compliance_score: 56, chronic_conditions: ['COPD', 'Υπέρταση'], er_visits_ytd: 3, total_claims_amount: 19800, is_active: true, last_claim_date: '2026-02-03' },
  { id: '21', member_code: 'MBR-021', full_name: 'Φωτεινή Ανδρέου', gender: 'F', date_of_birth: '1987-12-09', policy_type: 'Standard', risk_category: 'low', risk_score: 11, stability_score: 93, compliance_score: 90, chronic_conditions: ['Υποθυρεοειδισμός'], er_visits_ytd: 0, total_claims_amount: 1400, is_active: true, last_claim_date: '2025-12-15' },
  { id: '22', member_code: 'MBR-022', full_name: 'Αλέξανδρος Πέτρου', gender: 'M', date_of_birth: '1976-08-20', policy_type: 'Premium', risk_category: 'medium', risk_score: 44, stability_score: 69, compliance_score: 73, chronic_conditions: ['Διαβήτης Τ2'], er_visits_ytd: 1, total_claims_amount: 5200, is_active: true, last_claim_date: '2026-01-18' },
  { id: '23', member_code: 'MBR-023', full_name: 'Μαργαρίτα Φλώρου', gender: 'F', date_of_birth: '1969-05-11', policy_type: 'Standard', risk_category: 'medium', risk_score: 47, stability_score: 66, compliance_score: 68, chronic_conditions: ['Υπέρταση', 'Οστεοπόρωση'], er_visits_ytd: 1, total_claims_amount: 6100, is_active: true, last_claim_date: '2026-01-22' },
  { id: '24', member_code: 'MBR-024', full_name: 'Θεόδωρος Ράπτης', gender: 'M', date_of_birth: '1953-10-14', policy_type: 'Premium', risk_category: 'critical', risk_score: 85, stability_score: 30, compliance_score: 40, chronic_conditions: ['CHF', 'Διαβήτης Τ2', 'CKD Stage 3'], er_visits_ytd: 6, total_claims_amount: 52300, is_active: true, last_claim_date: '2026-02-14' },
  { id: '25', member_code: 'MBR-025', full_name: 'Ειρήνη Δράκου', gender: 'F', date_of_birth: '1991-04-03', policy_type: 'Basic', risk_category: 'low', risk_score: 9, stability_score: 96, compliance_score: 93, chronic_conditions: [], er_visits_ytd: 0, total_claims_amount: 280, is_active: true, last_claim_date: '2025-10-18' },
  { id: '26', member_code: 'MBR-026', full_name: 'Μιχάλης Κατσαρός', gender: 'M', date_of_birth: '1979-01-07', policy_type: 'Standard', risk_category: 'low', risk_score: 19, stability_score: 89, compliance_score: 86, chronic_conditions: [], er_visits_ytd: 0, total_claims_amount: 950, is_active: true, last_claim_date: '2025-11-25' },
  { id: '27', member_code: 'MBR-027', full_name: 'Γεωργία Μπακογιάννη', gender: 'F', date_of_birth: '1966-08-15', policy_type: 'Premium', risk_category: 'medium', risk_score: 50, stability_score: 63, compliance_score: 67, chronic_conditions: ['Ρευματοειδής αρθρίτιδα', 'Υπέρταση'], er_visits_ytd: 2, total_claims_amount: 8400, is_active: true, last_claim_date: '2026-01-25' },
  { id: '28', member_code: 'MBR-028', full_name: 'Σπύρος Παπαγεωργίου', gender: 'M', date_of_birth: '1983-06-22', policy_type: 'Basic', risk_category: 'low', risk_score: 13, stability_score: 94, compliance_score: 88, chronic_conditions: [], er_visits_ytd: 0, total_claims_amount: 420, is_active: true, last_claim_date: '2025-09-30' },
  { id: '29', member_code: 'MBR-029', full_name: 'Ολυμπία Στεφάνου', gender: 'F', date_of_birth: '1973-12-01', policy_type: 'Standard', risk_category: 'medium', risk_score: 43, stability_score: 71, compliance_score: 75, chronic_conditions: ['Θυρεοειδοπάθεια'], er_visits_ytd: 1, total_claims_amount: 4100, is_active: true, last_claim_date: '2026-01-12' },
  { id: '30', member_code: 'MBR-030', full_name: 'Ηλίας Τζανέτος', gender: 'M', date_of_birth: '1957-09-19', policy_type: 'Premium', risk_category: 'high', risk_score: 66, stability_score: 49, compliance_score: 54, chronic_conditions: ['Διαβήτης Τ2', 'Υπέρταση', 'Αρρυθμία'], er_visits_ytd: 2, total_claims_amount: 16200, is_active: true, last_claim_date: '2026-02-06' },
  { id: '31', member_code: 'MBR-031', full_name: 'Κατερίνα Βλάχου', gender: 'F', date_of_birth: '1996-03-08', policy_type: 'Basic', risk_category: 'low', risk_score: 6, stability_score: 99, compliance_score: 96, chronic_conditions: [], er_visits_ytd: 0, total_claims_amount: 120, is_active: true, last_claim_date: '2025-07-14' },
  { id: '32', member_code: 'MBR-032', full_name: 'Βαγγέλης Μαυρίδης', gender: 'M', date_of_birth: '1971-07-26', policy_type: 'Standard', risk_category: 'medium', risk_score: 46, stability_score: 67, compliance_score: 72, chronic_conditions: ['Δυσλιπιδαιμία'], er_visits_ytd: 1, total_claims_amount: 5500, is_active: true, last_claim_date: '2026-01-08' },
  { id: '33', member_code: 'MBR-033', full_name: 'Ρούλα Ζαφειρίου', gender: 'F', date_of_birth: '1984-10-30', policy_type: 'Premium', risk_category: 'low', risk_score: 17, stability_score: 91, compliance_score: 86, chronic_conditions: ['Αλλεργίες'], er_visits_ytd: 0, total_claims_amount: 1600, is_active: true, last_claim_date: '2025-12-28' },
  { id: '34', member_code: 'MBR-034', full_name: 'Αντώνης Καλαϊτζής', gender: 'M', date_of_birth: '1963-02-18', policy_type: 'Premium', risk_category: 'high', risk_score: 71, stability_score: 46, compliance_score: 57, chronic_conditions: ['Στεφανιαία νόσος', 'Υπέρταση'], er_visits_ytd: 3, total_claims_amount: 21400, is_active: true, last_claim_date: '2026-02-09' },
  { id: '35', member_code: 'MBR-035', full_name: 'Πηνελόπη Γιαννακοπούλου', gender: 'F', date_of_birth: '1989-05-25', policy_type: 'Standard', risk_category: 'low', risk_score: 11, stability_score: 94, compliance_score: 90, chronic_conditions: [], er_visits_ytd: 0, total_claims_amount: 600, is_active: true, last_claim_date: '2025-11-05' },
  { id: '36', member_code: 'MBR-036', full_name: 'Φίλιππος Ξενάκης', gender: 'M', date_of_birth: '1977-04-12', policy_type: 'Basic', risk_category: 'medium', risk_score: 39, stability_score: 73, compliance_score: 77, chronic_conditions: ['Γαστρίτιδα'], er_visits_ytd: 1, total_claims_amount: 3200, is_active: true, last_claim_date: '2026-01-02' },
  { id: '37', member_code: 'MBR-037', full_name: 'Άννα Λιάκου', gender: 'F', date_of_birth: '1994-08-16', policy_type: 'Basic', risk_category: 'low', risk_score: 8, stability_score: 97, compliance_score: 93, chronic_conditions: [], er_visits_ytd: 0, total_claims_amount: 200, is_active: true, last_claim_date: '2025-08-10' },
  { id: '38', member_code: 'MBR-038', full_name: 'Γρηγόρης Πολίτης', gender: 'M', date_of_birth: '1959-11-04', policy_type: 'Premium', risk_category: 'high', risk_score: 69, stability_score: 48, compliance_score: 53, chronic_conditions: ['COPD', 'Δυσλιπιδαιμία'], er_visits_ytd: 2, total_claims_amount: 15800, is_active: true, last_claim_date: '2026-02-02' },
  { id: '39', member_code: 'MBR-039', full_name: 'Νατάσα Κουτσούκου', gender: 'F', date_of_birth: '1981-01-21', policy_type: 'Standard', risk_category: 'low', risk_score: 14, stability_score: 90, compliance_score: 87, chronic_conditions: ['Υποθυρεοειδισμός'], er_visits_ytd: 0, total_claims_amount: 1900, is_active: true, last_claim_date: '2025-12-18' },
  { id: '40', member_code: 'MBR-040', full_name: 'Τάσος Μπέλλος', gender: 'M', date_of_birth: '1967-06-09', policy_type: 'Standard', risk_category: 'medium', risk_score: 49, stability_score: 64, compliance_score: 69, chronic_conditions: ['Υπέρταση', 'Διαβήτης Τ2'], er_visits_ytd: 1, total_claims_amount: 7300, is_active: true, last_claim_date: '2026-01-28' },
  { id: '41', member_code: 'MBR-041', full_name: 'Ελισάβετ Τριανταφύλλου', gender: 'F', date_of_birth: '1986-09-27', policy_type: 'Premium', risk_category: 'low', risk_score: 13, stability_score: 93, compliance_score: 89, chronic_conditions: ['Αλλεργίες'], er_visits_ytd: 0, total_claims_amount: 1100, is_active: true, last_claim_date: '2025-11-12' },
  { id: '42', member_code: 'MBR-042', full_name: 'Νεκτάριος Ζερβός', gender: 'M', date_of_birth: '1952-12-23', policy_type: 'Premium', risk_category: 'critical', risk_score: 87, stability_score: 25, compliance_score: 41, chronic_conditions: ['CHF', 'CKD Stage 3', 'Διαβήτης Τ2'], er_visits_ytd: 5, total_claims_amount: 48700, is_active: true, last_claim_date: '2026-02-13' },
  { id: '43', member_code: 'MBR-043', full_name: 'Μαριάννα Κορδά', gender: 'F', date_of_birth: '1997-03-06', policy_type: 'Basic', risk_category: 'low', risk_score: 5, stability_score: 98, compliance_score: 95, chronic_conditions: [], er_visits_ytd: 0, total_claims_amount: 100, is_active: true, last_claim_date: '2025-06-20' },
  { id: '44', member_code: 'MBR-044', full_name: 'Περικλής Αδαμόπουλος', gender: 'M', date_of_birth: '1975-08-14', policy_type: 'Standard', risk_category: 'medium', risk_score: 41, stability_score: 71, compliance_score: 76, chronic_conditions: ['Δυσλιπιδαιμία'], er_visits_ytd: 1, total_claims_amount: 4800, is_active: true, last_claim_date: '2026-01-16' },
  { id: '45', member_code: 'MBR-045', full_name: 'Δανάη Σαρρή', gender: 'F', date_of_birth: '1983-11-19', policy_type: 'Premium', risk_category: 'low', risk_score: 16, stability_score: 90, compliance_score: 88, chronic_conditions: ['Μιγράνα'], er_visits_ytd: 0, total_claims_amount: 2400, is_active: true, last_claim_date: '2025-12-22' },
  { id: '46', member_code: 'MBR-046', full_name: 'Λάμπρος Γαλανός', gender: 'M', date_of_birth: '1964-05-02', policy_type: 'Premium', risk_category: 'high', risk_score: 67, stability_score: 50, compliance_score: 55, chronic_conditions: ['Υπέρταση', 'Στεφανιαία νόσος'], er_visits_ytd: 2, total_claims_amount: 17600, is_active: true, last_claim_date: '2026-02-07' },
  { id: '47', member_code: 'MBR-047', full_name: 'Στέλλα Βαρδάκη', gender: 'F', date_of_birth: '1990-07-31', policy_type: 'Basic', risk_category: 'low', risk_score: 10, stability_score: 95, compliance_score: 91, chronic_conditions: [], er_visits_ytd: 0, total_claims_amount: 320, is_active: true, last_claim_date: '2025-09-08' },
  { id: '48', member_code: 'MBR-048', full_name: 'Ευθύμιος Ρήγας', gender: 'M', date_of_birth: '1972-02-11', policy_type: 'Standard', risk_category: 'medium', risk_score: 44, stability_score: 68, compliance_score: 72, chronic_conditions: ['Διαβήτης Τ2'], er_visits_ytd: 1, total_claims_amount: 5900, is_active: true, last_claim_date: '2026-01-20' },
  { id: '49', member_code: 'MBR-049', full_name: 'Καλλιόπη Μουστάκα', gender: 'F', date_of_birth: '1988-04-17', policy_type: 'Standard', risk_category: 'low', risk_score: 12, stability_score: 92, compliance_score: 87, chronic_conditions: ['Θυρεοειδοπάθεια'], er_visits_ytd: 0, total_claims_amount: 1500, is_active: true, last_claim_date: '2025-12-05' },
  { id: '50', member_code: 'MBR-050', full_name: 'Άγγελος Χρυσανθόπουλος', gender: 'M', date_of_birth: '1956-10-28', policy_type: 'Premium', risk_category: 'high', risk_score: 73, stability_score: 44, compliance_score: 51, chronic_conditions: ['COPD', 'Υπέρταση', 'Αρρυθμία'], er_visits_ytd: 3, total_claims_amount: 20500, is_active: true, last_claim_date: '2026-02-11' },
];
