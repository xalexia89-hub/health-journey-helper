...
const mockPosts: MedicalPost[] = [
  ...
  {
    id: 'p5',
    author: mockStoryGroups[4].profile,
    content_type: 'image',
    media_urls: ['https://images.unsplash.com/photo-1551076805-e1869033e561?w=800'],
    caption: '🦴 Ελάχιστα επεμβατική αρθροσκόπηση γόνατος — ο ασθενής περπάτησε 4 ώρες μετά την επέμβαση. Η τεχνολογία μας επιτρέπει να κάνουμε πράγματα που πριν 10 χρόνια φαίνονταν αδύνατα.\n\nΑν αντιμετωπίζετε χρόνιο πόνο στο γόνατο, μην τον αγνοείτε. Υπάρχουν λύσεις. 💪',
    tags: ['orthopedics', 'arthroscopy', 'minimalinvasive'],
    specialty_tags: ['Ορθοπεδική', 'Αρθροσκόπηση'],
    likes_count: 1890,
    comments_count: 123,
    saves_count: 345,
    shares_count: 67,
  ...
  {
    id: 'p6',
    author: mockStoryGroups[6].profile,
    content_type: 'carousel',
    media_urls: [
      'https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?w=800',
      'https://images.unsplash.com/photo-1612277795421-9bc7706a4a34?w=800',
    ],
    caption: '☀️ ΟΔΗΓΟΣ ΑΝΤΗΛΙΑΚΗΣ ΠΡΟΣΤΑΣΙΑΣ:\n\n✅ SPF 50+ κάθε μέρα, ακόμα και τον χειμώνα\n✅ Ανανέωση κάθε 2 ώρες\n✅ Αποφύγετε τον ήλιο 11:00-16:00\n✅ Φοράτε καπέλο και γυαλιά ηλίου\n✅ Ελέγχετε ελιές τακτικά με τον κανόνα ABCDE\n\nΗ πρόληψη είναι η καλύτερη θεραπεία! Κλείστε ραντεβού για δερματοσκόπηση. 🔬',
    tags: ['dermatology', 'sunprotection', 'prevention', 'skincare'],
    specialty_tags: ['Δερματολογία', 'Πρόληψη', 'Αντηλιακή Προστασία'],
    likes_count: 7234,
    comments_count: 456,
    saves_count: 1200,
    shares_count: 890,
  ...
  {
    id: 'p7',
    author: mockStoryGroups[5].profile,
    content_type: 'image',
    media_urls: ['https://images.unsplash.com/photo-1516549655169-df83a0774514?w=800'],
    caption: '🤖 Νέα εποχή στη χειρουργική! Το ρομποτικό σύστημα Da Vinci Xi εγκαταστάθηκε στο νοσοκομείο μας. Με ακρίβεια χιλιοστού, μικρότερες τομές και ταχύτερη ανάρρωση.\n\nΉδη 3 επιτυχημένες επεμβάσεις αυτήν την εβδομάδα:\n• Ολική υστερεκτομή\n• Νεφρεκτομή\n• Προστατεκτομή\n\nΤο μέλλον της ιατρικής είναι εδώ. 🏥',
    tags: ['roboticsurgery', 'davinci', 'innovation', 'technology'],
    specialty_tags: ['Ρομποτική Χειρουργική', 'Τεχνολογία'],
    likes_count: 4567,
    comments_count: 278,
    saves_count: 560,
    shares_count: 345,
    ...
    location: 'ΑΧΕΠΑ, Θεσσαλονίκη',
  },
  {
    id: 'p8',
    author: mockStoryGroups[7].profile,
    content_type: 'image',
    media_urls: ['https://images.unsplash.com/photo-1584820927498-cfe5211fd8bf?w=800'],
    caption: '📚 Σεμινάριο εκπαίδευσης νέων νοσηλευτών ΜΕΘ ολοκληρώθηκε! 12 νέοι συνάδελφοι είναι πλέον πιστοποιημένοι στη διαχείριση κρίσιμων ασθενών.\n\nΘέματα που καλύφθηκαν:\n• Μηχανικός αερισμός\n• Αιμοδυναμική παρακολούθηση\n• Φαρμακολογία ΜΕΘ\n• Πρωτόκολλα σήψης\n\nΤο νοσηλευτικό προσωπικό είναι η ραχοκοκαλιά κάθε νοσοκομείου. 💪❤️',
    tags: ['nursing', 'education', 'ICU', 'training'],
    specialty_tags: ['Νοσηλευτική', 'ΜΕΘ', 'Εκπαίδευση'],
    likes_count: 3120,
    comments_count: 189,
    saves_count: 234,
    shares_count: 156,
  ...
  },
  {
    ...
    author: {
      ...
      user_id: 'user-11',
      type: 'doctor',
      name: 'Δρ. Δημήτρης Κυριακίδης',
      username: 'dr.kyriakidis',
    ...
    content_type: 'image',
    media_urls: ['https://images.unsplash.com/photo-1628348068343-c6a848d2b6dd?w=800'],
    caption: '❤️ ΚΑΡΔΙΑΚΗ ΥΓΕΙΑ — Τι πρέπει να γνωρίζετε:\n\nΤο 80% των καρδιαγγειακών νοσημάτων μπορεί να προληφθεί!\n\n🔴 Παράγοντες κινδύνου:\n• Υπέρταση\n• Διαβήτης\n• Υπερχοληστερολαιμία\n• Κάπνισμα\n• Παχυσαρκία\n• Στρες\n\n🟢 Τι να κάνετε:\n• 30 λεπτά άσκηση/ημέρα\n• Μεσογειακή διατροφή\n• Τακτικός έλεγχος μετά τα 40\n• Μετρήστε την πίεσή σας\n\nΗ καρδιά σας αξίζει προσοχή! Κλείστε ραντεβού ελέγχου. 🩺',
    tags: ['cardiology', 'heartHealth', 'prevention', 'lifestyle'],
    specialty_tags: ['Καρδιολογία', 'Πρόληψη', 'Υγιεινή Ζωή'],
    likes_count: 8945,
    comments_count: 567,
    saves_count: 2100,
    shares_count: 1234,
    ...
    location: 'Ωνάσειο Καρδιοχειρουργικό',
  },
  {
    id: 'p10',
    author: mockStoryGroups[3].profile,
    content_type: 'carousel',
    media_urls: [
    ...
    caption: '🏥 ΙΑΤΡΙΚΟ ΚΕΝΤΡΟ ΑΘΗΝΩΝ — Νέες υπηρεσίες!\n\nΜε χαρά ανακοινώνουμε:\n\n✨ Νέο τμήμα Ψηφιακής Παθολογίας με AI ανάλυση\n✨ Check-up Premium σε 3 ώρες\n✨ Τηλεϊατρική 24/7 για τους ασθενείς μας\n✨ Νέο MRI 3 Tesla — η πιο ακριβής απεικόνιση\n\nΗ υγεία σας είναι η προτεραιότητά μας.\nΚλείστε ραντεβού online ή καλέστε: 210-XXXXXXX 📞',
    tags: ['medicalcenter', 'healthcare', 'technology', 'checkup'],
    specialty_tags: ['Ιατρικό Κέντρο', 'Τεχνολογία', 'Check-up'],
    likes_count: 2890,
    comments_count: 167,
    saves_count: 456,
    shares_count: 234,
  ...
  },
  {
    ...
    author: {
      ...
      user_id: 'user-12',
      type: 'doctor',
      name: 'Δρ. Ιωάννα Μαυρίδου',
      username: 'dr.mavridou',
      avatar_url: 'https://images.unsplash.com/photo-1594824476967-48c8b964273f?w=150',
    ...
    content_type: 'image',
    media_urls: ['https://images.unsplash.com/photo-1559757148-5c350d0d3c56?w=800'],
    caption: '👶 ΓΟΝΕΙΣ ΠΡΟΣΟΧΗ — Εποχικές ιώσεις:\n\nΤα παιδιά είναι ευάλωτα αυτή την εποχή. Συμβουλές:\n\n1️⃣ Πλύσιμο χεριών — ο Νο1 κανόνας!\n2️⃣ Σωστή ενυδάτωση\n3️⃣ Αν ο πυρετός ξεπεράσει τους 38.5°C, δώστε αντιπυρετικό\n4️⃣ Μην δίνετε αντιβίωση χωρίς γιατρό!\n5️⃣ Αν έχει δύσπνοια ή εξάνθημα → ΑΠ ΕΥΘΕΙΑΣ στον γιατρό\n\nΑν δεν είστε σίγουροι, ρωτήστε πάντα τον παιδίατρό σας. Καλύτερα μια παραπάνω επίσκεψη παρά μια λιγότερη. 🩺💙',
    tags: ['pediatrics', 'children', 'fever', 'parenting'],
    specialty_tags: ['Παιδιατρική', 'Ιώσεις', 'Πρόληψη'],
    likes_count: 6543,
    comments_count: 432,
    saves_count: 1890,
    shares_count: 678,
  ...
  },
  {
    ...
    author: {
      ...
      user_id: 'user-13',
      type: 'doctor',
      name: 'Δρ. Αλέξανδρος Παπαδάκης',
      username: 'dr.papadakis.psych',
      avatar_url: 'https://images.unsplash.com/photo-1582750433449-648ed127bb54?w=150',
      specialty: 'Ψυχιατρική',
      verification_status: 'verified',
    ...
    content_type: 'image',
    media_urls: ['https://images.unsplash.com/photo-1544027993-37dbfe43562a?w=800'],
    caption: '🧠 ΨΥΧΙΚΗ ΥΓΕΙΑ — Δεν είναι πολυτέλεια, είναι ανάγκη.\n\nΣημάδια που δεν πρέπει να αγνοήσετε:\n\n• Επίμονη θλίψη > 2 εβδομάδες\n• Διαταραχές ύπνου\n• Απώλεια ενδιαφέροντος\n• Αίσθημα αξιότητας\n• Δυσκολία συγκέντρωσης\n• Κοινωνική απόσυρση\n\nΤο να ζητήσεις βοήθεια δεν είναι αδυναμία. Είναι δύναμη. 💪\n\nΓραμμή ψυχολογικής υποστήριξης: 1018 (24ωρη)\n\n#mentalhealth #ψυχικηυγεια #δενεισαιμονος',
    tags: ['mentalhealth', 'psychology', 'depression', 'awareness'],
    specialty_tags: ['Ψυχιατρική', 'Ψυχική Υγεία', 'Ευαισθητοποίηση'],
    likes_count: 12340,
    comments_count: 789,
    saves_count: 3456,
    shares_count: 2100,
